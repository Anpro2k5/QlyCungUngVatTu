...
<div class="container">
    ...
    %>
        ...
        <div class="card">
            <h3>Chức năng dành cho Quản lý Kho</h3>
            <ul>
                <li><a href="mathang/list" class="btn">Quản lý Mặt hàng</a></li>
                <li><a href="phieunhap/list" class="btn">Theo dõi Phiếu nhập</a></li>
                <li><a href="phieuxuat/list" class="btn">Theo dõi Phiếu xuất</a></li>
            </ul>
        </div>
    <%
        } else {
